...
class login_page:
    def __init__(self, root):
        self.window = root
        self.window.title("Log In to Number plate detection system")
        ...
        self.frame3.place(x=450,y=150,width=450,height=450)
        ...
        self.create_button = Button(self.frame3,text="Create New Account",command=self.redirect_window,font=("times new roman",18, "bold"),bd=1,cursor="hand2",bg="SkyBlue2",fg="lemon chiffon").place(x=80,y=320,width=250)
