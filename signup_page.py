...
class SignUp:
    def __init__(self, root):
        ...
        self.signup = Button(frame,text="Sign Up",command=self.signup_func,font=("times new roman",18, "bold"),bd=0,cursor="hand2",bg="SkyBlue2",fg="lemon chiffon").place(x=120,y=470,width=250)
        #self.signup = Button(frame,text="Already have account",command=self.signup,font=("times new roman",12, "bold"),bd=0,cursor="hand2",bg="white",fg="blue").place(x=165,y=515,width=150)
    ...
    def redirect_window_login(self):
         self.window.destroy()
